        ...
        >
          <div className="main-container main-container--deep">
            ...
            <div className="bf-ui-card bf-ui-card--no-padding bf-ui-card--elevated">
              <div className="feedback-container">
                ...
                />
                <StateBuy
                  value={transaction?.shipment.estado}
                  success={
                    transaction?.shipment.estado === "entregado"
                      ? "success"
                      : "error"
                  }
                />
          ...
          <div className="detail-container">
            <div className="detail-container bf-ui-ticket">
              ...
              <DetailPay
                valueLeft={'Pago'}
                valueRight={transaction?.payment.estado}
                caseDetail={"state"}
                success={
                  transaction?.payment.estado === "rechazada" ||
                  transaction?.payment.estado === "cancelada"
                    ? "fail"
                    : "success"
                }
              />
